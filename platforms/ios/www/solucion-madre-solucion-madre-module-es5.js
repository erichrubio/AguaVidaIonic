...
var SolucionMadrePageRoutingModule = /** @class */ (function () {
    function SolucionMadrePageRoutingModule() {
    }
    ...
    return SolucionMadrePageRoutingModule;
}());
...
var SolucionMadrePageModule = /** @class */ (function () {
    function SolucionMadrePageModule() {
    }
    ...
    return SolucionMadrePageModule;
}());
...
var SolucionMadrePage = /** @class */ (function () {
    function SolucionMadrePage() {
        // final value to display
        this.c_solucion_str = "";
    }
    SolucionMadrePage.prototype.ngOnInit = function () {
    ...
    SolucionMadrePage.prototype.onSubmit = function (values) {
        console.log('c_solucion submit button clicked.');
        console.log(values);
        var r1 = (values.peso_cloro * (values.p_cloro / 100)) / values.l_solucion;
...
//# sourceMappingURL=solucion-madre-solucion-madre-module-es5.js.map