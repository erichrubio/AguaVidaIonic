...
var PesoAutoPageRoutingModule = /** @class */ (function () {
    function PesoAutoPageRoutingModule() {
    }
    ...
    return PesoAutoPageRoutingModule;
}());
...
var PesoAutoPageModule = /** @class */ (function () {
    function PesoAutoPageModule() {
    }
...
var PesoAutoPage = /** @class */ (function () {
    function PesoAutoPage() {
        // final value to display
        this.peso_auto_str = "";
    }
    PesoAutoPage.prototype.ngOnInit = function () {
    ...
    PesoAutoPage.prototype.onSubmit = function (values) {
        console.log('peso_auto submit button clicked.');
        console.log(values);
        var c = values.caudal;
        var v = values.t_solucion;
        var d = values.c_reservorio;
        var g;
        if (c < 1.38) {
            g = 1;
        }
        ...
        var r = 0.36 * (v * c * d) / (g * values.p_cloro);
        // kg to grams
        r = r * 1000;
...
//# sourceMappingURL=peso-auto-peso-auto-module-es5.js.map